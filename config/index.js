export const config = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "生日", "name": "宝子", "year": "1995", "date": "01-26"},
        {"type": "节日", "name": "相识纪念日", "year": "2021", "date": "12-01"},
      ],
      ...
      customizedDateList: [
        ...
        // 结婚纪念日
        {"keyword": "marry_day", date: "2022-07-23"},
        // 退伍日
        {"keyword": "ex_day", date: "2022-07-23"},
      ]
    },
    {
      name: "",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "贺彤彤", "year": "2002", "date": "07-07"},
        {"type": "节日", "name": "相恋纪念日", "year": "2022", "date": "07-23"},
    // 你可以不断按格式往下增加
    // ...
  ],
